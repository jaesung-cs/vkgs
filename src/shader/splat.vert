...
void main() {
  ...
  vec3 ndc_position = quads[index * 3 + 0].xyz;
  mat2 rot_scale = mat2(quads[index * 3 + 1].xy, quads[index * 3 + 1].zw);
  vec4 color = quads[index * 3 + 2];
